        ...
        <div class="overflow-x-auto">
          <table class="w-full min-w-200">
            <thead class="bg-neutral-50/60 border-b border-neutral-200">
              <tr>
                <th class="px-6 py-3 text-left text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">User</th>
                <th class="px-6 py-3 text-left text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">Role</th>
                <th class="px-6 py-3 text-left text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">Level</th>
                <th class="px-6 py-3 text-left text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">Status</th>
                <th class="px-6 py-3 text-left text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">Joined</th>
                <th class="px-6 py-3 text-right text-[10px] font-semibold text-neutral-400 uppercase tracking-[0.12em]">Actions</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-neutral-100">
              <tr v-for="user in filteredUsers" :key="user.user_id" class="hover:bg-neutral-50/70 transition-colors">
                <!-- User -->
                ...
                <!-- Role -->
                <td class="px-6 py-2.5">                    <span :class="user.role_id <= 2 ? 'bg-ink/10 text-ink' : 'bg-info/10 text-info'"
                    class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold uppercase tracking-wide">
                ...
                <!-- Level -->
                <td class="px-6 py-2.5">
                  <span class="text-[11px] font-semibold text-neutral-400">{{ getRoleLevel(user).level }}</span>
                </td>

                <!-- Status -->
                <td class="px-6 py-2.5">
                  <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-accent/10 text-accent">
                ...
                <!-- Joined -->
                <td class="px-6 py-2.5">
                  <span class="text-[11px] text-neutral-400">{{ formatDate(user.created) }}</span>
                </td>
